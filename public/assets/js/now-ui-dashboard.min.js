...
!function () {
    ...
    nowuiDashboard = {
        ...
        showNotification: function (from, align, message, type) {
            ...
            $.notify({
                icon: type === 'success' ? 'now-ui-icons ui-1_check' : 'now-ui-icons ui-1_simple-remove',
                message: message
            }, {
                type: color,
                timer: 8000,
